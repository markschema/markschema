...
export const comparison = {
  ...
  rows: [
    ...
    {
      capability: 'Structure validation (heading order, section sequence, field presence)',
      mdshape: 'Native' as const,
      zodRemark: 'Custom required' as const,
      markdoc: 'Custom required' as const,
  ...
  legend: [
    { term: 'Native', definition: 'Works out of the box, no custom code needed.' },
    { term: 'Partial', definition: 'Possible but requires extra work or has gaps.' },
